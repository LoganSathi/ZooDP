...
public class Zoo extends javax.swing.JFrame {
    ...
    private void allImage(java.awt.event.ActionEvent animalEvent) {//GEN-FIRST:event_allActionPerformed
        ...
        Animal lion = catfactory.createAnimal("lion");
        Animal tiger = catfactory.createAnimal("tiger");
        Animal duck = birdfactory.createAnimal("duck");
        Animal swan = birdfactory.createAnimal("swan");
        //-------------------------------------------Facade Pattern----------------------------------------------

        AnimalFacade animals = new AnimalFacade(horseEquus, duck, donkeyEquus, swan, zebraEquus, tiger, lion);
     ...
     */
    public JLabel getZebra() {
        return zebra;
    }

    public void setZebra(JLabel zebra) {
        this.zebra = zebra;
    }

    public JLabel getSwan() {
        return swan;
    }

    public void setSwan(JLabel swan) {
        this.swan = swan;
    }

    public JLabel getDuck() {
        return duck;
    }

    public void setDuck(JLabel duck) {
        this.duck = duck;
    }

    public JLabel getTiger() {
        return tiger;
    }

    public void setTiger(JLabel tiger) {
        this.tiger = tiger;
    }

    public JLabel getLion() {
        return lion;
    }

    public void setLion(JLabel lion) {
        this.lion = lion;
    }

    public JLabel getDonkey() {
        return donkey;
    }

    public void setDonkey(JLabel donkey) {
        this.donkey = donkey;
    }

    public JButton getBackgroundMusicButton() {
        return backgroundMusicButton;
    }

    public void setBackgroundMusicButton(JButton backgroundMusicButton) {
        this.backgroundMusicButton = backgroundMusicButton;
    }
    ...
    public void setHorse(JLabel horse) {
        this.horse = horse;
    }
